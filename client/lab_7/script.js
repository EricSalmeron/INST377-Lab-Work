...
function injectHTML(list) {
  ...
  /*
    ...
    ## What to do in this function
      ...
      - using a .forEach method, inject a list element into your index.html for every elemen
...
function processRestaurants(list) {
  ...
  /*
      ...
      - Create an array of 15 empty elements (there are a lot of fun ways to do this, and also ve
...
async function mainEvent() {
  /*
      ## Main Event
        Separating your main programming from your side functions will help you organize y
  ...
  /*
      ...
      The 'data' key, which we set at line 38 in foodServiceRoutes.js, contains all 
    */
  console.table(arrayFromJson.data);

  // in your browser console, try expanding this object to see what fields are availa
